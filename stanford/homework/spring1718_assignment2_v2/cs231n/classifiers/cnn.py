...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # Backward pass
        d_hidden_out, d_W3, d_b3 = affine_backward(grads, score_cache)
        d_conv_out, d_W2, d_b2 = affine_relu_backward(d_hidden_out, hidden_cache)
        dX, d_W1, d_b1 = conv_relu_pool_backward(d_conv_out, conv_cache)
        
        
        
        grads = {
            "W1": d_W1 + self.reg * self.params['W1'],
            "b1": d_b1,
            "W2": d_W2 + self.reg * self.params['W2'],
            "b2": d_b2,
            "W3": d_W3 + self.reg * self.params['W3'],
            "b3": d_b3,
        }
